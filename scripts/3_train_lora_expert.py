...
from hers.lora import train_lora
from omegaconf import OmegaConf
import sys

cfg = OmegaConf.load("configs/lora_train.yaml")
damage_type = sys.argv[1]

train_lora(
    image_dir=f"data/images/{damage_type}",
    output_dir=f"outputs/lora_experts/{damage_type}",
    cfg=cfg
)